...
export default class extends Component {
  ...
  componentDidMount() {
    ...
    function RenderSkin() {
      ...
      headBox.faceVertexUvs[0][6] = [
        headBottom[0],
        headBottom[3],
        headBottom[1],
      ];
      headBox.faceVertexUvs[0][7] = [
        headBottom[3],
        headBottom[2],
        headBottom[1],
      ];
      ...
      bodyBox.faceVertexUvs[0][6] = [
        bodyBottom[0],
        bodyBottom[3],
        bodyBottom[1],
      ];
      bodyBox.faceVertexUvs[0][7] = [
        bodyBottom[3],
        bodyBottom[2],
        bodyBottom[1],
      ];
      ...
      rightArmBox.faceVertexUvs[0][1] = [
        rightArmRight[0],
        rightArmRight[1],
        rightArmRight[2],
      ];
      rightArmBox.faceVertexUvs[0][2] = [
        rightArmLeft[3],
        rightArmLeft[0],
        rightArmLeft[2],
      ];
      rightArmBox.faceVertexUvs[0][3] = [
        rightArmLeft[0],
        rightArmLeft[1],
        rightArmLeft[2],
      ];
      rightArmBox.faceVertexUvs[0][4] = [
        rightArmTop[3],
        rightArmTop[0],
        rightArmTop[2],
      ];
      rightArmBox.faceVertexUvs[0][5] = [
        rightArmTop[0],
        rightArmTop[1],
        rightArmTop[2],
      ];
      rightArmBox.faceVertexUvs[0][6] = [
        rightArmBottom[0],
        rightArmBottom[3],
        rightArmBottom[1],
      ];
      rightArmBox.faceVertexUvs[0][7] = [
        rightArmBottom[3],
        rightArmBottom[2],
        rightArmBottom[1],
      ];
      rightArmBox.faceVertexUvs[0][8] = [
        rightArmFront[3],
        rightArmFront[0],
        rightArmFront[2],
      ];
      rightArmBox.faceVertexUvs[0][9] = [
        rightArmFront[0],
        rightArmFront[1],
        rightArmFront[2],
      ];
      rightArmBox.faceVertexUvs[0][10] = [
        rightArmBack[3],
        rightArmBack[0],
        rightArmBack[2],
      ];
      rightArmBox.faceVertexUvs[0][11] = [
        rightArmBack[0],
        rightArmBack[1],
        rightArmBack[2],
      ];
      ...
      leftArmBox.faceVertexUvs[0][1] = [
        leftArmRight[0],
        leftArmRight[1],
        leftArmRight[2],
      ];
      leftArmBox.faceVertexUvs[0][2] = [
        leftArmLeft[3],
        leftArmLeft[0],
        leftArmLeft[2],
      ];
      leftArmBox.faceVertexUvs[0][3] = [
        leftArmLeft[0],
        leftArmLeft[1],
        leftArmLeft[2],
      ];
      leftArmBox.faceVertexUvs[0][4] = [
        leftArmTop[3],
        leftArmTop[0],
        leftArmTop[2],
      ];
      leftArmBox.faceVertexUvs[0][5] = [
        leftArmTop[0],
        leftArmTop[1],
        leftArmTop[2],
      ];
      leftArmBox.faceVertexUvs[0][6] = [
        leftArmBottom[0],
        leftArmBottom[3],
        leftArmBottom[1],
      ];
      leftArmBox.faceVertexUvs[0][7] = [
        leftArmBottom[3],
        leftArmBottom[2],
        leftArmBottom[1],
      ];
      leftArmBox.faceVertexUvs[0][8] = [
        leftArmFront[3],
        leftArmFront[0],
        leftArmFront[2],
      ];
      leftArmBox.faceVertexUvs[0][9] = [
        leftArmFront[0],
        leftArmFront[1],
        leftArmFront[2],
      ];
      leftArmBox.faceVertexUvs[0][10] = [
        leftArmBack[3],
        leftArmBack[0],
        leftArmBack[2],
      ];
      leftArmBox.faceVertexUvs[0][11] = [
        leftArmBack[0],
        leftArmBack[1],
        leftArmBack[2],
      ];
      ...
      rightLegBox.faceVertexUvs[0][1] = [
        rightLegRight[0],
        rightLegRight[1],
        rightLegRight[2],
      ];
      rightLegBox.faceVertexUvs[0][2] = [
        rightLegLeft[3],
        rightLegLeft[0],
        rightLegLeft[2],
      ];
      rightLegBox.faceVertexUvs[0][3] = [
        rightLegLeft[0],
        rightLegLeft[1],
        rightLegLeft[2],
      ];
      rightLegBox.faceVertexUvs[0][4] = [
        rightLegTop[3],
        rightLegTop[0],
        rightLegTop[2],
      ];
      rightLegBox.faceVertexUvs[0][5] = [
        rightLegTop[0],
        rightLegTop[1],
        rightLegTop[2],
      ];
      rightLegBox.faceVertexUvs[0][6] = [
        rightLegBottom[0],
        rightLegBottom[3],
        rightLegBottom[1],
      ];
      rightLegBox.faceVertexUvs[0][7] = [
        rightLegBottom[3],
        rightLegBottom[2],
        rightLegBottom[1],
      ];
      rightLegBox.faceVertexUvs[0][8] = [
        rightLegFront[3],
        rightLegFront[0],
        rightLegFront[2],
      ];
      rightLegBox.faceVertexUvs[0][9] = [
        rightLegFront[0],
        rightLegFront[1],
        rightLegFront[2],
      ];
      rightLegBox.faceVertexUvs[0][10] = [
        rightLegBack[3],
        rightLegBack[0],
        rightLegBack[2],
      ];
      rightLegBox.faceVertexUvs[0][11] = [
        rightLegBack[0],
        rightLegBack[1],
        rightLegBack[2],
      ];
      ...
      leftLegBox.faceVertexUvs[0][1] = [
        leftLegRight[0],
        leftLegRight[1],
        leftLegRight[2],
      ];
      leftLegBox.faceVertexUvs[0][2] = [
        leftLegLeft[3],
        leftLegLeft[0],
        leftLegLeft[2],
      ];
      leftLegBox.faceVertexUvs[0][3] = [
        leftLegLeft[0],
        leftLegLeft[1],
        leftLegLeft[2],
      ];
      leftLegBox.faceVertexUvs[0][4] = [
        leftLegTop[3],
        leftLegTop[0],
        leftLegTop[2],
      ];
      leftLegBox.faceVertexUvs[0][5] = [
        leftLegTop[0],
        leftLegTop[1],
        leftLegTop[2],
      ];
      leftLegBox.faceVertexUvs[0][6] = [
        leftLegBottom[0],
        leftLegBottom[3],
        leftLegBottom[1],
      ];
      leftLegBox.faceVertexUvs[0][7] = [
        leftLegBottom[3],
        leftLegBottom[2],
        leftLegBottom[1],
      ];
      leftLegBox.faceVertexUvs[0][8] = [
        leftLegFront[3],
        leftLegFront[0],
        leftLegFront[2],
      ];
      leftLegBox.faceVertexUvs[0][9] = [
        leftLegFront[0],
        leftLegFront[1],
        leftLegFront[2],
      ];
      leftLegBox.faceVertexUvs[0][10] = [
        leftLegBack[3],
        leftLegBack[0],
        leftLegBack[2],
      ];
      leftLegBox.faceVertexUvs[0][11] = [
        leftLegBack[0],
        leftLegBack[1],
        leftLegBack[2],
      ];
      ...
      head2Box.faceVertexUvs[0][6] = [
        head2Bottom[0],
        head2Bottom[3],
        head2Bottom[1],
      ];
      head2Box.faceVertexUvs[0][7] = [
        head2Bottom[3],
        head2Bottom[2],
        head2Bottom[1],
      ];
      head2Box.faceVertexUvs[0][8] = [
        head2Front[3],
        head2Front[0],
        head2Front[2],
      ];
      head2Box.faceVertexUvs[0][9] = [
        head2Front[0],
        head2Front[1],
        head2Front[2],
      ];
      head2Box.faceVertexUvs[0][10] = [
        head2Back[3],
        head2Back[0],
        head2Back[2],
      ];
      head2Box.faceVertexUvs[0][11] = [
        head2Back[0],
        head2Back[1],
        head2Back[2],
      ];
      ...
      body2Box.faceVertexUvs[0][6] = [
        body2Bottom[0],
        body2Bottom[3],
        body2Bottom[1],
      ];
      body2Box.faceVertexUvs[0][7] = [
        body2Bottom[3],
        body2Bottom[2],
        body2Bottom[1],
      ];
      body2Box.faceVertexUvs[0][8] = [
        body2Front[3],
        body2Front[0],
        body2Front[2],
      ];
      body2Box.faceVertexUvs[0][9] = [
        body2Front[0],
        body2Front[1],
        body2Front[2],
      ];
      body2Box.faceVertexUvs[0][10] = [
        body2Back[3],
        body2Back[0],
        body2Back[2],
      ];
      body2Box.faceVertexUvs[0][11] = [
        body2Back[0],
        body2Back[1],
        body2Back[2],
      ];
      ...
      rightArm2Box.faceVertexUvs[0][1] = [
        rightArm2Right[0],
        rightArm2Right[1],
        rightArm2Right[2],
      ];
      rightArm2Box.faceVertexUvs[0][2] = [
        rightArm2Left[3],
        rightArm2Left[0],
        rightArm2Left[2],
      ];
      rightArm2Box.faceVertexUvs[0][3] = [
        rightArm2Left[0],
        rightArm2Left[1],
        rightArm2Left[2],
      ];
      rightArm2Box.faceVertexUvs[0][4] = [
        rightArm2Top[3],
        rightArm2Top[0],
        rightArm2Top[2],
      ];
      rightArm2Box.faceVertexUvs[0][5] = [
        rightArm2Top[0],
        rightArm2Top[1],
        rightArm2Top[2],
      ];
      rightArm2Box.faceVertexUvs[0][6] = [
        rightArm2Bottom[0],
        rightArm2Bottom[3],
        rightArm2Bottom[1],
      ];
      ...
      rightArm2Box.faceVertexUvs[0][8] = [
        rightArm2Front[3],
        rightArm2Front[0],
        rightArm2Front[2],
      ];
      rightArm2Box.faceVertexUvs[0][9] = [
        rightArm2Front[0],
        rightArm2Front[1],
        rightArm2Front[2],
      ];
      rightArm2Box.faceVertexUvs[0][10] = [
        rightArm2Back[3],
        rightArm2Back[0],
        rightArm2Back[2],
      ];
      rightArm2Box.faceVertexUvs[0][11] = [
        rightArm2Back[0],
        rightArm2Back[1],
        rightArm2Back[2],
      ];
      ...
      leftArm2Box.faceVertexUvs[0][1] = [
        leftArm2Right[0],
        leftArm2Right[1],
        leftArm2Right[2],
      ];
      leftArm2Box.faceVertexUvs[0][2] = [
        leftArm2Left[3],
        leftArm2Left[0],
        leftArm2Left[2],
      ];
      leftArm2Box.faceVertexUvs[0][3] = [
        leftArm2Left[0],
        leftArm2Left[1],
        leftArm2Left[2],
      ];
      leftArm2Box.faceVertexUvs[0][4] = [
        leftArm2Top[3],
        leftArm2Top[0],
        leftArm2Top[2],
      ];
      leftArm2Box.faceVertexUvs[0][5] = [
        leftArm2Top[0],
        leftArm2Top[1],
        leftArm2Top[2],
      ];
      leftArm2Box.faceVertexUvs[0][6] = [
        leftArm2Bottom[0],
        leftArm2Bottom[3],
        leftArm2Bottom[1],
      ];
      leftArm2Box.faceVertexUvs[0][7] = [
        leftArm2Bottom[3],
        leftArm2Bottom[2],
        leftArm2Bottom[1],
      ];
      leftArm2Box.faceVertexUvs[0][8] = [
        leftArm2Front[3],
        leftArm2Front[0],
        leftArm2Front[2],
      ];
      leftArm2Box.faceVertexUvs[0][9] = [
        leftArm2Front[0],
        leftArm2Front[1],
        leftArm2Front[2],
      ];
      leftArm2Box.faceVertexUvs[0][10] = [
        leftArm2Back[3],
        leftArm2Back[0],
        leftArm2Back[2],
      ];
      leftArm2Box.faceVertexUvs[0][11] = [
        leftArm2Back[0],
        leftArm2Back[1],
        leftArm2Back[2],
      ];
      ...
      rightLeg2Box.faceVertexUvs[0][1] = [
        rightLeg2Right[0],
        rightLeg2Right[1],
        rightLeg2Right[2],
      ];
      rightLeg2Box.faceVertexUvs[0][2] = [
        rightLeg2Left[3],
        rightLeg2Left[0],
        rightLeg2Left[2],
      ];
      rightLeg2Box.faceVertexUvs[0][3] = [
        rightLeg2Left[0],
        rightLeg2Left[1],
        rightLeg2Left[2],
      ];
      rightLeg2Box.faceVertexUvs[0][4] = [
        rightLeg2Top[3],
        rightLeg2Top[0],
        rightLeg2Top[2],
      ];
      rightLeg2Box.faceVertexUvs[0][5] = [
        rightLeg2Top[0],
        rightLeg2Top[1],
        rightLeg2Top[2],
      ];
      rightLeg2Box.faceVertexUvs[0][6] = [
        rightLeg2Bottom[0],
        rightLeg2Bottom[3],
        rightLeg2Bottom[1],
      ];
      rightLeg2Box.faceVertexUvs[0][7] = [
        rightLeg2Bottom[3],
        rightLeg2Bottom[2],
        rightLeg2Bottom[1],
      ];
      rightLeg2Box.faceVertexUvs[0][8] = [
        rightLeg2Front[3],
        rightLeg2Front[0],
        rightLeg2Front[2],
      ];
      rightLeg2Box.faceVertexUvs[0][9] = [
        rightLeg2Front[0],
        rightLeg2Front[1],
        rightLeg2Front[2],
      ];
      rightLeg2Box.faceVertexUvs[0][10] = [
        rightLeg2Back[3],
        rightLeg2Back[0],
        rightLeg2Back[2],
      ];
      rightLeg2Box.faceVertexUvs[0][11] = [
        rightLeg2Back[0],
        rightLeg2Back[1],
        rightLeg2Back[2],
      ];
      ...
      leftLeg2Box.faceVertexUvs[0][1] = [
        leftLeg2Right[0],
        leftLeg2Right[1],
        leftLeg2Right[2],
      ];
      leftLeg2Box.faceVertexUvs[0][2] = [
        leftLeg2Left[3],
        leftLeg2Left[0],
        leftLeg2Left[2],
      ];
      leftLeg2Box.faceVertexUvs[0][3] = [
        leftLeg2Left[0],
        leftLeg2Left[1],
        leftLeg2Left[2],
      ];
      leftLeg2Box.faceVertexUvs[0][4] = [
        leftLeg2Top[3],
        leftLeg2Top[0],
        leftLeg2Top[2],
      ];
      leftLeg2Box.faceVertexUvs[0][5] = [
        leftLeg2Top[0],
        leftLeg2Top[1],
        leftLeg2Top[2],
      ];
      leftLeg2Box.faceVertexUvs[0][6] = [
        leftLeg2Bottom[0],
        leftLeg2Bottom[3],
        leftLeg2Bottom[1],
      ];
      leftLeg2Box.faceVertexUvs[0][7] = [
        leftLeg2Bottom[3],
        leftLeg2Bottom[2],
        leftLeg2Bottom[1],
      ];
      leftLeg2Box.faceVertexUvs[0][8] = [
        leftLeg2Front[3],
        leftLeg2Front[0],
        leftLeg2Front[2],
      ];
      leftLeg2Box.faceVertexUvs[0][9] = [
        leftLeg2Front[0],
        leftLeg2Front[1],
        leftLeg2Front[2],
      ];
      leftLeg2Box.faceVertexUvs[0][10] = [
        leftLeg2Back[3],
        leftLeg2Back[0],
        leftLeg2Back[2],
      ];
      leftLeg2Box.faceVertexUvs[0][11] = [
        leftLeg2Back[0],
        leftLeg2Back[1],
        leftLeg2Back[2],
      ];
